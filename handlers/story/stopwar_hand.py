...
async def stopwar_timer(message: Message, bot: Bot):
    ...
    if user_info['datetime_end'] is None:  # c is не работает так как объект находится не в озу а в базе
        ...
        await message.answer("5 минут прошли, спасибо, что поделились ссылкой на меня! Вы можете перейти в главное меню."
                             ...
                             "Всё открыто и прозрачно, <a href='https://t.me/Russia_Svoboda/67'>посмотрите пост</a> и убедитесь сами.</i>", reply_markup=markup.as_markup(resize_keyboard=True), parse_mode="HTML")
...
async def stopwar_share_blindly(message: Message):
    ...
    if timer == '1':
        ...
        await message.answer("5 минут прошли, спасибо, что поделились ссылкой на меня! Вы можете перейти в главное меню."
                             ...
                             "<i>Найдите сообщение, содержащее ложь, сделайте скриншот и отправьте в комментариях к <a href='https://t.me/Russia_Svoboda/67'>этому посту.</a> "
                             "Не забудьте прикрепить доказательства! Я абсолютно серьёзно. "
                             "Всё открыто и прозрачно, <a href='https://t.me/Russia_Svoboda/67'>посмотрите пост</a> и убедитесь сами.</i>", reply_markup=nmarkup.as_markup(resize_keyboard=True),  parse_mode="HTML")
