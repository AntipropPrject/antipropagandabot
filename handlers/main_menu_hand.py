...
@router.message(SubscriberFilter(), F.text.in_({'Хочу пообщаться ещё раз! 🇷🇺🇺🇦', 'База Лжи 👀', 'Мини-игры 🎲'}), flags=flags)
async def mainmenu_need_subscr(message: Message, state: FSMContext):
